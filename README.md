...
оформление заказа или выводить ему сообщение про ошибку. Вся обработка идет на js.
...
При тправке используются дополнительные параметры которые требует API.
Для выставления значения  параметров, также можно использовать дополнительный метод для редактирования заказа.
